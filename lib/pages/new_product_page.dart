        ...
        children: [
          ...
          Card(
            ...
            child: Row(
              ...
              children: [
                ElevatedButton.icon(onPressed: _showDatePicker,
                    icon: const Icon(Icons.date_range),
                    label: const Text('Select Date'),),
                Text(_dateTime == null ? 'No date chosen' : getFormattedDate(_dateTime!, 'MMM dd, yyy')),
              ],
            ),
          ),
          const SizedBox(height: 10,),
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: _imagePath == null? Image.asset('images/img.png')
